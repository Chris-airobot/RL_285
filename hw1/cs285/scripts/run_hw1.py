...
def run_training_loop(params):
    ...
    for itr in range(params['n_iter']):
        ...
        #   random_indices = np.random.permutation(params['train_batch_size'])
          random_indices = np.random.permutation(replay_buffer.obs.shape[0])[:params['train_batch_size']]
